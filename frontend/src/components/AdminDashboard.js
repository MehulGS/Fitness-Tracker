...
const AdminDashboard = () => {
    ...
    return (
        <Container maxWidth="lg">
            <Box mt={5}>
                <Typography variant="h4" align="center" sx={{color:"white"}} gutterBottom fontWeight="bold">
                    Admin Dashboard
                </Typography>
                    ...
                    <Grid container spacing={4}>
                        {userStatistics.map(({ user, goals, workouts }) => (
                            <Grid item xs={12} sm={6} md={4} key={user._id}>
                                <StyledCard sx={{backgroundColor:"#f5426f"}}>
                                    <CardContent>
                                        ...
                                        <Box display="flex" alignItems="center" mt={2}>
                                            ...
                                            <Typography variant="subtitle1" ml={1} sx={{color:"white"}}>
                                                Goals
                                            </Typography>
                                        </Box>
